...
USAGE: ./diploidify.sh -v|--vcf <path_to_vcf> [--separate-homologs] [-c|--chrom-sizes <path_to_chrom_sizes_file>] [-r|--resolutions resolutions_string] [-p|--psf <path_to_psf>] [--reads-to-homologs <path_to_reads_to_homologs_file>] [-j|--juicer-dir <path_to_juicer_dir>] [-p|--phaser-dir <path_to_phaser_dir>] [-t|--threads thread_count] [-T|--threads-hic hic_thread_count] [--from-stage <stage>] [--to-stage <stage>] <path_to_merged_dedup_bam_1> ... <path_to_merged_dedup_bam_N>
